...
class _AboutPagePageState extends State<AboutScreen> {
  ...
  Widget _buildPageIndicator(bool isCurrentPage) {
    return Container(
      ...
      decoration: BoxDecoration(
        color:
            isCurrentPage ? AppColors.PAGE_INDICATOR_ACTIVE_DOT_COLOR : AppColors.PAGE_INDICATOR_INACTIVE_DOT_COLOR,
                ...
                child: Column(children: [
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        getText(
                            text: Strings.TAKE_YOUR_HELTH_TO,
