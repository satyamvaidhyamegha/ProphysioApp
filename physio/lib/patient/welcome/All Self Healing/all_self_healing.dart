...
import 'package:physio/patient/welcome/Explorer%20Procare/explore_procare_screen.dart';
...
class AllSelfHealing extends StatefulWidget {
  const AllSelfHealing({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AllSelfHealingPageState();
  }
}

class _AllSelfHealingPageState extends State<AllSelfHealing>
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      doNavigate(
                          route: ExploreProCareScreen(), context: context);
                    },
                    icon: Icon(
            ...
            body: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                  Container(
                    color: AppColors.allSelfHealingPicBgColor,
                    child: Padding(
