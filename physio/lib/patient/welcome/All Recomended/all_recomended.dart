...
import 'package:physio/patient/welcome/All%20Self%20Care/all_safe_care.dart';
...
class AllRecomdedYouScreen extends StatefulWidget {
  const AllRecomdedYouScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AllRecomdedYouScreenPageState();
  }
}

class _AllRecomdedYouScreenPageState extends State<AllRecomdedYouScreen>
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      doNavigate(
                          route: AllSelfCareScreen(), context: context);
                    },
                    icon: Icon(
            ...
            body: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                  Container(
                    color: AppColors.allRecomendedPicBgColor,
                    child: Padding(
