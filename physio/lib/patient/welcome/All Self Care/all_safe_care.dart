...
import 'package:physio/patient/welcome/All%20Self%20Healing/all_self_healing.dart';
...
class AllSelfCareScreen extends StatefulWidget {
  const AllSelfCareScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AllSelfCareScreenPageState();
  }
}

class _AllSelfCareScreenPageState extends State<AllSelfCareScreen>
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      doNavigate(
                          route: AllSelfHealing(), context: context);
                    },
                    icon: Icon(
            ...
            body: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                  Container(
                    color: AppColors.allSelfCarePicBgColor,
                    child: Padding(
