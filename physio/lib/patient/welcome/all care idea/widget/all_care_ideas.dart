...
import 'package:physio/patient/welcome/All%20Recomended/all_recomended.dart';
...
class AllCareIdeasScreen extends StatefulWidget {
  const AllCareIdeasScreen({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _AllCareIdeasScreenPageState();
  }
}

class _AllCareIdeasScreenPageState extends State<AllCareIdeasScreen>
        ...
        child: Scaffold(
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      doNavigate(
                          route: AllRecomdedYouScreen(), context: context);
                    },
                    icon: Icon(
            ...
            body: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                  Container(
                    color: AppColors.allCareIdeasPhotosBgcolor,
                    child: Padding(
