...
class AssesmentSuggestedSlider extends StatefulWidget {
  const AssesmentSuggestedSlider({Key? key}) : super(key: key);

  @override
  State<AssesmentSuggestedSlider> createState() =>
      _AssesmentSuggestedSliderState();
}

class _AssesmentSuggestedSliderState extends State<AssesmentSuggestedSlider> {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                verticalGap(
                                    context: context, screenSize: 0.008),
                                Text(
