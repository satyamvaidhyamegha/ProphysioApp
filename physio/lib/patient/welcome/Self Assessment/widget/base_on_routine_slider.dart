...
class BaseInRoutineSlider extends StatefulWidget {
  const BaseInRoutineSlider({Key? key}) : super(key: key);

  @override
  State<BaseInRoutineSlider> createState() =>
      _BaseInRoutineSliderState();
}

class _BaseInRoutineSliderState extends State<BaseInRoutineSlider> {
