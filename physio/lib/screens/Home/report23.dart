...
class Report23 extends StatefulWidget {
  const Report23({Key? key}) : super(key: key);

  @override
  _Report23State createState() => _Report23State();
}

class _Report23State extends State<Report23> {
  int present = 0;
  int perPage = 3;
                      ...
                      Row(
                        children: [
                          IconButton(
                              ...
                              onPressed: () {}),
                          getText(
                              text: 'Select Patient', textStyle: aboutYouText1)
                        ],
                      ),
                    ])),
