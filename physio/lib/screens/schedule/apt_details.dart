...
class AptDetails extends StatefulWidget {
  const AptDetails({super.key});

  @override
  State<AptDetails> createState() => _AptDetailsState();
}

var windowWidth;
var windowHeight;

class _AptDetailsState extends State<AptDetails> {
  @override
          ...
          Row(
            children: [
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(
                      top: MediaQuery.of(context).size.height * 0.08, left: 12),
              ...
              Container(
                  ...
                  child:
                      getText(text: 'Apt Details', textStyle: aboutYouText1)),
            ],
          ),
                      ...
                      Column(
                        children: [
                          ...
                          Row(
                            children: [
                              getParaText(
                                  text: '3:00am - 4:00am', textStyle: subtitle2)
                            ],
                          ),
                        ],
                      )
                    ...
                    Column(children: [
                      ...
                      Row(
                        children: [
                          ...
                          getText(text: '+91 99498769', textStyle: subtitle2),
                        ],
                      ),
                      Row(
                        children: [
