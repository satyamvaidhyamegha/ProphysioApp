        ...
        child: Column(
          children: [
            ...
            Row(children: [
              horizontalGap(context: context, screenSize: 0.04),
              getText(
                  text: 'Patient updates', textStyle: profilefieldtextStyle3),
                          ...
                          Column(children: [
                            Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  horizontalGap(
                                      context: context, screenSize: 0.34),
                                  getText(
                                      text: "Yesterday",
            ...
            Row(children: [
              horizontalGap(context: context, screenSize: 0.04),
              getText(text: 'New messages', textStyle: profilefieldtextStyle3),
              horizontalGap(context: context, screenSize: 0.4),
              getText(text: '(25)', textStyle: todaytext),
              horizontalGap(context: context, screenSize: 0.04),
              const Icon(
                            ...
                            Padding(
                                ...
                                child: Row(children: [
                                  getText(
                                      ...
                                      textStyle: aboutYouText1),
                                  horizontalGap(
                                      context: context, screenSize: 0.38),
                                  getText(
                                      text: "Today", textStyle: navlablecolor2),
                                  horizontalGap(
                                      context: context, screenSize: 0.002),
                                  const Icon(
                                    Icons.arrow_forward_ios_outlined,
            ...
            Row(children: [
              horizontalGap(context: context, screenSize: 0.04),
              getText(text: 'New Exercises', textStyle: profilefieldtextStyle3),
              horizontalGap(context: context, screenSize: 0.4),
              getText(text: '(25)', textStyle: todaytext),
              horizontalGap(context: context, screenSize: 0.04),
              const Icon(
